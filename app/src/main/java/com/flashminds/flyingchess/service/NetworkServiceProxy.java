...
public class NetworkServiceProxy implements ServiceConnection {
    private static final String TAG = "Mars.Sample.MarsServiceProxy";

    // public static final String SERVICE_ACTION = "BIND_MARS_SERVICE";
    public static final String SERVICE_DEFAULT_CLASSNAME = "com.flashminds.flyingchess.service.NetworkService";
    ...
    public static NetworkServiceProxy inst;
    private static String gPackageName;
    private static String gClassName;

    private NetworkServiceProxy.Worker worker;
    ...
    private NetworkServiceProxy() {
        worker = new NetworkServiceProxy.Worker();
        worker.start();
    }
